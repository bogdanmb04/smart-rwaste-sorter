...
const int CYAN_PIN = 16;
const int MAGENTA_PIN = 5;
...
void setColor(int cyan, int magenta, int yellow) {
  cyan = constrain(cyan, 0, PWM_MAX);
  magenta = constrain(magenta, 0, PWM_MAX);
  yellow = constrain(yellow, 0, PWM_MAX);
  
  analogWrite(CYAN_PIN, cyan);
  analogWrite(MAGENTA_PIN, magenta);
